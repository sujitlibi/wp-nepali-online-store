...
if ( $woodmart_widget_product_img_size ) {
	$img = woodmart_otf_get_image_html( get_post_thumbnail_id( $product->get_id() ), $woodmart_widget_product_img_size, $woodmart_widget_product_img_size_custom );
} else {
